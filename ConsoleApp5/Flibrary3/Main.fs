...
let main argv =
    ...
    let text = new Label(Font = new Font(familyName = "Segoe UI",emSize = 15.0f), Height = 30, Width= 550, Text="Введите по форме: aХ^2 + bХ + с")
    ...
    let richTextBox1 = new Label(Font = new Font(familyName = "Segoe UI",emSize = 18.0f), Height = 150, Width = 700, Top = 200, Left = 0,Text="")
